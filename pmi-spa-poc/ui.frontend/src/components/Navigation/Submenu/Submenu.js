                        ...
                        <ul>
                            {this.props.items.map(({boldtext, boldText, shorttext, fieldLabel}) => (
                                <li onClick={(e) => this.openSubMenu(fieldLabel, e)}>
                                    {fieldLabel && <div className="arrowRight"><img
                                        src="/etc.clientlibs/pmi-spa-poc/clientlibs/clientlib-react/resources/arrowRight.svg" alt="logo"></img></div>}
                        ...
                        {this.state.fieldLabels &&
                            <ul>
                                {this.state.fieldLabels.map(({boldtext, plaintext, teaserImagePath}) => (
                                    <li>
                                        {teaserImagePath &&
                                            <div className="small-image"><img src={teaserImagePath._authorUrl} alt="iqos"></img></div>}
